...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/03 12:39:43 by agardina          #+#    #+#             */
/*   Updated: 2021/11/03 12:39:46 by agardina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cmp_operands_atime_reverse(void *content1, void *content2)
{
	...
	s1 = ((t_ls_tree_node *)content1)->info.st_atimespec;
	s2 = ((t_ls_tree_node *)content2)->info.st_atimespec;
